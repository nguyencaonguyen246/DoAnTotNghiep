...
<head>
    ...
    <title>Kỹ thuật - Đăng nhập</title>
...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="card card-login mx-auto mt-5">
            ...
            <div class="card-body">
                <form action="<?php echo BASE_URL?>tieptan/tieptandangnhap" method="POST">
                    ...
                    <button class="btn btn-primary btn-block" type="submit" name="btndangnhapTiepTan">Đăng nhập</button>
                </form>
