...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="card card-login mx-auto mt-5">
            ...
            <div class="card-body">
                <form action="<?php echo BASE_URL?>kythuat/kythuatdangnhap" method="POST">
                    ...
                    <button class="btn btn-primary btn-block" type="submit" name="btndangnhapKT">Đăng nhập</button>
                </form>
