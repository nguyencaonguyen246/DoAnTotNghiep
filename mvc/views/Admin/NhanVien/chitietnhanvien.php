    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <a href="<?php echo BASE_URL?>admin/xemnhanvien">Danh sách nhân
                            viên</a></li>
                    <li class="breadcrumb-item active"> <a>Chi tiết</a></li>
                </ol>
                <div class="card mb-3">
                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                                $ngay = date_create($row['ngaysinh']);
                                                $ngaysinh = $ngay -> format('d-m-Y');
                                                echo $ngaysinh;
                                            ?>
                                        </td>
                                    </tr>
