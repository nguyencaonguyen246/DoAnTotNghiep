            ...
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <a
                            href="<?php echo BASE_URL?>admin/xemdssanpham/<?php echo  $_SESSION['mancc'];?>">Danh sách
                            sản phẩm</a></li>
                    <li class="breadcrumb-item"> <a href="<?php echo BASE_URL?>admin/sanphamdat">Danh sách sản phẩm
                            đặt</a></li>
                ...
                <div class="card mb-3">
                    ...
                    <?php
                        if(isset($_SESSION['danhsachnhap']) && is_array($_SESSION['danhsachnhap'])){?>
                    <div class="card-body">
                        <div style="padding-left: 100px; padding-right: 100px;">
                            <div style="font-size: 30px; text-align: center;">PHIẾU ĐẶT HÀNG</div>
                            <div>GỬI: <?php echo $dataview['tenncc'];?> </div>
                        ...
                        <div style="text-align: center;">
                            <a type="button" style="width: max-content;"
                                href="<?php echo BASE_URL?>admin/post_themphieudat/<?php echo $_SESSION["manv"] ?>/<?php echo $_SESSION['mancc'];?>"
                                class="button2 b-green rot-135"><i class="fas fa-file-alt"></i> Tạo phiếu đặt
                                hàng</a>
                        </div>
                    </div>
                    <?php }
                                ...
                                <div class="alert alert-warning">
                                    <h2>Không tồn tại phiếu đặt hàng</h2>
                                </div>
                        <?php }
                    ?>
