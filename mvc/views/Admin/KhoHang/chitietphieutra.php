            ...
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/xemdanhsachphieutra">Danh sách phiếu trả</a>
                    </li>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                     ...
                                     while ($row = mysqli_fetch_array($dataview["ctpt"])){
                                    ?>
                                        <tr>
                        ...
                        <a type="button" style="width: max-content;" href="<?php echo BASE_URL?>admin/xuatpdfphieutra/<?php echo $dataview['mapt']?>"
                                                class="button2 b-green rot-135"><i class="fas fa-print"></i> In phiếu trả hàng</a>   
                            </div>
                    </div>
                </div>
            </div>
