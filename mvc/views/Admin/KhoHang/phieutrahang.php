            ...
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/xemnhacungcap">Danh sách nhà cung cấp</a>
                    </li>
                    <li class="breadcrumb-item"> <a
                            href="<?php echo BASE_URL?>admin/xemsanphamloi/<?php echo $dataview['mancc'];?>">Danh sách
                            sản phẩm lỗi</a></li>
                    <li class="breadcrumb-item active">Xem phiếu trả hàng</li>
                </ol>
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div style="padding-left: 100px; padding-right: 100px;">
                            <div style="font-size: 30px; text-align: center;">PHIẾU TRẢ HÀNG</div>
                            <div>GỬI: <?php echo $dataview['tenncc'];?> </div>
                            <div>Đây là những linh kiện bị lỗi trong thời gian bảo hành</div>
                            <div>Danh sách các linh kiện yêu cầu hoàn trả: </div>
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                     ...
                                     while ($row = mysqli_fetch_array($dataview["sploi"])){
                                    ?>
                                        <tr>
                        ...
                        <div style="text-align: center;">
                                <a type="button" style="width: max-content;"
                                    href="<?php echo BASE_URL?>admin/post_themphieutra/<?php echo $_SESSION["manv"] ?>/<?php echo $dataview['mancc'];?>"
                                    class="button2 b-green rot-135"><i class="fas fa-file-alt"></i> Tạo phiếu trả
                                    hàng</a>
                            </div>
                    </div>
                </div>
