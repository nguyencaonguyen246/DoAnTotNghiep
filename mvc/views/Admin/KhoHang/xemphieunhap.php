            ...
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/xemdanhsachphieudat">Danh sách phiếu đặt</a>
                    </li>
                    <li class="breadcrumb-item"><a
                            href="<?php echo BASE_URL?>admin/chitietphieudat/<?php echo $dataview['mapd'];?>/<?php echo $dataview['mancc'];?>">Xem
                            phiếu đặt hàng</a> </li>
                    <li class="breadcrumb-item"><a href="#">Xem phiếu nhập hàng</a> </li>
                </ol>
                <div class="card mb-3">
                    ...
                    <form method="post" action="<?php echo BASE_URL?>admin/taophieunhap/<?php echo $dataview['mapd']?>/<?php echo $dataview['mancc']?>">
                        <div class="card-body">
                            <div style="padding-left: 100px; padding-right: 100px;">
                                <div style="font-size: 30px; text-align: center;">PHIẾU NHẬP HÀNG</div>
                                <div>GỬI TỪ: <?php echo $dataview['ten'];?> </div>
                                <div>Danh sách các linh kiện đã đặt: </div>
                                <div class="table-responsive">
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                     ...
                                     while ($row = mysqli_fetch_array($dataview["ctpn"])){
                                    ?>
                                            <tr>
                                                ...
                                                <td align="center"><input style="width: 60px;" type="number" min="0"
                                                        name="soluong[<?php echo $row['masp'];?>]"
                                                        value="<?php echo $row['soluong']; ?>" required="required"/></td>
                                                <td align="center"><input style="width: 100px;" type="number" min="1000"
                                                        name="gianhap[<?php echo $row['masp'];?>]" required="required"/> VNĐ
                                                </td>
                                ...
                                <div style="text-align: right;">CapCuuDienThoai.Com</div>
                                <div style="text-align: center;">
                                    <button type="submit" style="width: max-content;"
                                        name="taophieunhap"
                                        class="button2 b-blue rot-135"><i class="fas fa-check"></i> Xác nhận tạo phiếu nhập & Nhập kho
                                        </button>
                                </div>
                            </div>
