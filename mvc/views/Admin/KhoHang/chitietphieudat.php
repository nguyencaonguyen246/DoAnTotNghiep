        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Xem phiếu đặt hàng</a> </li>
                    <li class="breadcrumb-item active">Xem phiếu nhập hàng</li>
                </ol>
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div style="padding-left: 100px; padding-right: 100px;">
                            <div style="font-size: 30px; text-align: center;">PHIẾU ĐẶT HÀNG</div>
                            <div>GỬI: <?php echo $dataview['ten'];?> </div>
                            <div>Danh sách các linh kiện cần đặt: </div>
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                     ...
                                     while ($row = mysqli_fetch_array($dataview["ctpd"])){
                                    ?>
                                        <tr>
                            ...
                            <div style="text-align: center;">
                                <a type="button" style="width: max-content;" href="<?php echo BASE_URL?>admin/xuatpdfphieudat/<?php echo $dataview['mapd']?>"
                                                class="button2 b-green rot-135"><i class="fas fa-print"></i> In phiếu đặt hàng</a>    
                                <a type="button" style="width: max-content;" href="<?php echo BASE_URL?>admin/phieunhaphang/<?php echo $dataview['mapd'];?>/<?php echo $dataview['mancc'];?>"
                                                class="button2 b-blue rot-135"><i class="fas fa-plus"></i> Tạo phiếu nhập hàng</a>    
                            </div>
                        </div>
