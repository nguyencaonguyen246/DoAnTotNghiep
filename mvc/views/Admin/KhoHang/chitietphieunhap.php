            ...
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/dsphieunhap">Danh sách phiếu nhập hàng</a>
                    </li>
                    <li class="breadcrumb-item active">Xem chi tiết phiếu nhập hàng</li>
                </ol>
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div style="padding-left: 100px; padding-right: 100px;">
                            ...
                            <div>Nhập từ nhà cung cấp: <?php echo $dataview['tenncc'];?> </div>
                            <div>Nhân viên nhập kho: <?php echo  $dataview["tennhanvien"]?></div>
                            <div>Danh sách các linh kiện đã nhập: </div>
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td align="center"><?php echo number_format($row["gianhap"], 0,',','.');?> VNĐ</td>

                                            <td align="center"><?php echo number_format($row["thanhtien"], 0,',','.');?> VNĐ</td>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php echo number_format($dataview['tongtien'], 0,',','.');?> VNĐ</td>
                                        </tr>
                                </table>
                            ...
                            <a type="button" style="width: max-content;" href="<?php echo BASE_URL?>admin/xuatpdfphieunhap/<?php echo $dataview['mapn']?>"
                                                class="button2 b-green rot-135"><i class="fas fa-print"></i> In phiếu nhập kho</a>    
                            </div>
                        </div>
