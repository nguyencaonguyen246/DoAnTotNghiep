...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand static-top" style="height: 50px;">
        ...
        <a class="navbar-brand mr-1" style="color: #CCCCCC;" href="<?php echo BASE_URL?>admin/index"><?php echo $_SESSION['tennhanvien']?></a>
                ...
                <div class="row">
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">Đang cập nhật</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-success o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?php echo $dataview['ycmuahang']?> Đơn chưa xác nhận!</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="<?php echo BASE_URL?>admin/chuaxacnhan">
                                <span class="float-left">Xem chi tiết</span>
                                <span class="float-right">
                                    <i class="fas fa-angle-right"></i>
                                </span>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                <div class="card-body-icon">
                                    <i class="fas fa-fw fas fa-toolbox"></i>
                                </div>
                                <div class="mr-5"><?php echo $dataview['ycsuachua']?> Yêu cầu sửa chữa!</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="<?php echo BASE_URL?>admin/yeucausuachua">
                                <span class="float-left">Xem chi tiết</span>
                                <span class="float-right">
                                    <i class="fas fa-angle-right"></i>
                                </span>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-danger o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?php echo $dataview['ycbaohanh']?> Yêu cầu bảo hành!</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="<?php echo BASE_URL?>admin/yeucaubaohanh">
                                <span class="float-left">Xem chi tiết</span>
                                <span class="float-right">
                                    <i class="fas fa-angle-right"></i>
                                </span>
