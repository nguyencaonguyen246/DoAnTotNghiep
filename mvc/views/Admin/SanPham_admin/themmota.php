        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Thêm mô tả</li>
                </ol>
                ...
                <div class="card mb-3">
                    ...
                    <form action="<?php echo BASE_URL?>admin/post_themmota/<?php echo $dataview["MASP_mota"]?>"
                            ...
                            <div class="table-responsive">
                                <table class="table" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea style="width: 100%; height: 200px;" name="mota"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="cus-input" type="text" name="thongtinthem"
                                                required="required" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="center">
                                            <button style="width: max-content;" type="submit" name="themmota"
                                                class="button2 b-blue rot-135">
                                                Thêm </button>
                                        </td>

                                    </tr>
                                    <!-- mã sản phẩm ở đây để ẩn  -->
                                    <tr style="display: none;">
                                        <td colspan="2">
                                            <input class="cus-input" type="text" name="masp" required="required"
                                                value="<?php echo $dataview["MASP_mota"]?>" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
