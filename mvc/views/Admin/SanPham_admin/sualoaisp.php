...
<body id="page-top">
            ...
            <li class="nav-item active dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item" href="<?php echo BASE_URL?>admin/themnsx"><i class="fas fa-plus"></i>
                        Thêm nhà sản xuất</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item active" href="<?php echo BASE_URL?>admin/loaisanpham"><i class="fas fa-plus"></i>
            ...
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/loaisanpham">Danh sách loại sản phẩm</a>
                    </li>
                ...
                <div class="card mb-3">
                    ...
                    <?php 
                            $row = mysqli_fetch_array($dataview["chitietloaisp"]);
                    ?>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <form
                                            action="<?php echo BASE_URL?>admin/post_sualoaisp/<?php echo $row['maloai']?>"
                                            method="POST">
                                            <th width="180">Tên loại sản phẩm:</th>
                                            <td align="center">
                                                <input style="width: 100%;" name="tenloai" id="tenloai" type="text"
                                                    value="<?php echo $row['tenloai'];?>" />
                                                <div style="color: red; font-size: 14px;" id="messtenloai"></div>
                                                <button style="width: max-content;" type="submit" name="sualoaisp"
   ...
   $(document).ready(function() {
        $("#tenloai").keyup(function() {
            var loai = $(this).val();
            $.post("<?php echo BASE_URL?>Ajax/ktratenloai", {
                tenloai: loai
            }, function(data) {
                $("#messtenloai").html(data);
            });
        });
    });
    </script>
