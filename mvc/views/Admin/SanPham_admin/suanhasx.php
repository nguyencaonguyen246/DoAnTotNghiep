...
<body id="page-top">
            ...
            <li class="nav-item active dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item" href="<?php echo BASE_URL?>admin/themncc"><i class="fas fa-plus"></i>
                        Thêm nhà cung cấp</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item active" href="<?php echo BASE_URL?>admin/themnsx"><i class="fas fa-plus"></i>
                        Thêm nhà sản xuất</a>
                    <div class="dropdown-divider"></div>
            ...
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/themnsx">Danh sách nhà sản xuất</a>
                    </li>
                ...
                <div class="card mb-3">
                    ...
                    <?php 
                            $row = mysqli_fetch_array($dataview["chitietnsx"]);
                    ?>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <form
                                            action="<?php echo BASE_URL?>admin/post_suansx/<?php echo $row['mansx']?>"
                                            method="POST">
                                            <th width="180">Tên nhà sản xuất:</th>
                                            <td align="center">
                                                <input style="width: 100%;" name="tennsx" id="tennsx" type="text"
                                                    value="<?php echo $row['tennsx'];?>" />
                                                <div style="color: red; font-size: 14px;" id="messtennsx"></div>
                                                <button style="width: max-content;" type="submit" name="suansx"
    ...
    $(document).ready(function() {
        $("#tennsx").keyup(function() {
            var nsx = $(this).val();
            $.post("<?php echo BASE_URL?>Ajax/ktratennsx", {
                tennsx: nsx
            }, function(data) {
                $("#messtennsx").html(data);
            });
        });
    });
    </script>
