...
<body id="page-top">
            ...
            <li class="nav-item active dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item " href="<?php echo BASE_URL?>admin/themdanhmuc"><i class="fas fa-plus"></i>
                        Thêm danh mục</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item active" href="<?php echo BASE_URL?>admin/themncc"><i class="fas fa-plus"></i>
                        Thêm nhà cung cấp</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item " href="<?php echo BASE_URL?>admin/themnsx"><i
                            class="fas fa-plus"></i>
                        Thêm nhà sản xuất</a>
                    <div class="dropdown-divider"></div>
            ...
            <div class="container-fluid">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/themncc">Danh sách nhà cung cấp</a>
                    </li>
                ...
                <div class="card mb-3">
                    ...
                    <div>
                        <?php
                            if(isset($dataview["ketqua_ncc"])) {
                                if($dataview["ketqua_ncc"]){?>
                        <h4 class="alert alert-success"><i class="fas fa-check"></i> Sửa thành công</h4>
                        <?php }
                                else{ ?>
                        <h4 class="alert alert-danger"><i class="fas fa-times"></i> Sửa thất bại</h4>
                        <?php }
                        }?>
                    </div>
                    <?php 
                        $row = mysqli_fetch_array($dataview['chitietncc']);
                    ?>
                    <div style="padding: 20px;">
                        <form action="<?php echo BASE_URL?>admin/post_suanhacungcap/<?php echo $row['mancc']?>" method="POST">
                            <div>
                                <table class="table">
                                    <tr>
                                        <td>Tên nhà cung cấp: </td>
                                        <td> 
                                            <input style="width:100%" type=" text" value="<?php echo $row['tenncc']?>" class="cus-input" id="tenncc" name="tenncc"  required="required">
                                            <div style="color: red; font-size: 13px; text-align: right;" id="messtenncc"></div>
                                        </td>

                                        <td style="padding-left:10px;">Số điện thoại: </td>
                                        <td> 
                                            <input type="number" style="width:100%" value="<?php echo $row['sdtncc']?>" class="cus-input"  id="sdtncc" name="sdtncc"  required="required">
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <input type="text" style="width:100%" class="cus-input" value="<?php echo $row['diachi']?>"  id="diachi" name="diachi"  required="required">
                                            <div style="color: red; font-size: 14px; text-align: right;" id="messtime"></div>
                                        </td>

                                        <td style="padding-left:10px;">Email: </td>
                                        <td> 
                                            <input type="email" style="width:100%" class="cus-input"  id="email" name="email" value="<?php echo $row['email']?>"  required="required">
                                            <div style="color: red; font-size: 14px; text-align: right;" id="messtime_end"></div>
                                        </td>
                                    </tr>
                                    <tr >
                                        <td align="center" colspan="4" style="padding-top: 15px;"> 
                                            <button style="width: max-content;" type="submit" name="suancc" class="button2 b-green rot-135"> <i class="far fa-edit"></i> Sửa</button>
                                        </td>
                                    </tr>
                                </table>
                            </div>
    ...
    $(document).ready(function() {
        $("#tenncc").keyup(function() {
            var ncc = $(this).val();
            $.post("<?php echo BASE_URL?>Ajax/ktratenncc", {
                tenncc: ncc
            }, function(data) {
                $("#messtenncc").html(data);
            });
        });
    });
    $(document).ready(function() { // kiểm tra độ dài số điện thoại
            $("#sdtncc").keyup(function() {
                var adsdt = $(this).val();
                $.post("<?php echo BASE_URL ?>Ajax/ktraDoDaiSdtNCC", {
                    sdtncc: adsdt
                }, function(data) {
