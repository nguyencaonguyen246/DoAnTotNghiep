            ...
            <li class="nav-item active dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item" href="<?php echo BASE_URL?>admin/themsanpham"><i class="fas fa-plus"></i>
                        Thêm sản phẩm</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item " href="<?php echo BASE_URL?>admin/themdanhmuc"><i
                            class="fas fa-plus"></i>
                        Thêm danh mục</a>
                    <div class="dropdown-divider"></div>
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item active" href="<?php echo BASE_URL?>admin/themkhuyenmai"><i class="fas fa-tags"></i>
                        Thêm khuyến mãi</a>
                </div>
            </li>
            <?php 
        ...
        <div id="content-wrapper">
            ...
            <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/themkhuyenmai">Danh sách khuyến mãi</a>
                    </li>
                ...
                <div class="card mb-3">
                    ...
                    <div>
                        <?php
                            if(isset($dataview["ketquasua"])) {
                                if($dataview["ketquasua"]){?>
                ...
                <?php 
                            $row = mysqli_fetch_array($dataview["chitietkm"]);
                    ?>
                <div class="card-body">
                <form action="<?php echo BASE_URL?>admin/post_suakhuyenmai/<?php echo $row['makhuyenmai']?>" method="POST">
                    <div class="table-responsive">
                        <table class="table table-bordered"  width="100%" cellspacing="0">
                            ...
                            <tr>
                                    ...
                                    <td align="center">
                                        <input style="width: 100%;" name="tenkhuyenmai" id="tenkhuyenmai" type="text" value="<?php echo $row['tenkhuyenmai'];?>"/>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <input style="width: 100%;" name="giatrikhuyenmai" id="giatrikhuyenmai" type="text" value="<?php echo $row['giatrikhuyenmai'];?>"/>
                                ...
                                <tr>
                                    <th>Ngày bắt đầu:</th>
                                    <td align="center">
                                        <input style="width: 100%;" type="date" name="thoigianbatdau" id="thoigianbatdau" type="text" value="<?php echo $row['thoigianbatdau'];?>"/>
                                ...
                                <tr>
                                    <th>Ngày kết thúc:</th>
                                    <td align="center">
                                        <input style="width: 100%;" type="date" name="thoigianketthuc" id="thoigianketthuc" type="text" value="<?php echo $row['thoigianketthuc'];?>"/>
                                        
                                    </td>
                                    
                                </tr>
                                <tr>
                                    <td align="center" colspan="2"> <button style="width: max-content;" type="submit"
                                            name="suakhuyenmai" class="button2 b-blue rot-135">
                                            <i class="fas fa-edit"></i> Sửa</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
