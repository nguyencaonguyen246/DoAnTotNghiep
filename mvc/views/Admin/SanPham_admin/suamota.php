        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Chỉnh sửa mô tả</li>
                </ol>
                ...
                <div class="card mb-3">
                    ...
                    <?php 
                            $row = mysqli_fetch_array($dataview["mota"]);
                    ?>
                    <form action="<?php echo BASE_URL?>admin/post_suamota/<?php echo $row["mamota"];?>/<?php echo $dataview["MASP_mota"];?>" method="post"
                            ...
                            <div class="table-responsive">
                                <table class="table" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        <th>Tiêu đề</th>
                                        <td>
                                            <input class="cus-input" type="text" name="tieude" required="required"
                                                autofocus="autofocus"  value="<?php echo $row["tieude"];?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Mô tả sản phẩm</th>
                                        <td>
                                            <textarea style="width: 100%; height: 200px;" name="mota" required="required" ><?php echo $row["mota"];?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Công dụng</th>
                                        <td>
                                            <input class="cus-input" type="text" name="congdung" required="required"
                                            value="<?php echo $row["congdung"];?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th width="280">Thông tin thêm về sản phẩm</th>
                                        <td>
                                            <input class="cus-input" type="text" name="thongtinthem" required="required" 
                                            value="<?php echo $row["thongtinthem"];?>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="center">
                                            <button style="width: max-content;" type="submit" name="suamota"
                                                class="button2 b-blue rot-135">
                                                Lưu thay đổi </button>
                                        </td>
