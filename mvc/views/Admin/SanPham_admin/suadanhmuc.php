        ...
        <div id="content-wrapper">
            ...
            <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/themdanhmuc">Danh sách danh mục</a>
                    </li>
                ...
                <?php 
                            $row = mysqli_fetch_array($dataview["chitietdanhmuc"]);
                    ?>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered"  width="100%" cellspacing="0">
                            <tbody>
                                <tr>
                                    <form action="<?php echo BASE_URL?>admin/post_suadanhmuc/<?php echo $row['madm']?>" method="POST">
                                        <th width="150">Tên danh mục:</th>
                                        <td align="center">
                                            <input style="width: 100%;" name="tendm" id="tendm" type="text" value="<?php echo $row['tendm'];?>"/>
