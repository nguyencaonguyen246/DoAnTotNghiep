            ...
            <li class="nav-item active dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item" href="<?php echo BASE_URL?>admin/loadhoadon"><i
                            ...
                            <div class="dropdown-divider"></div>
                    <a class="dropdown-item active" href="<?php echo BASE_URL?>admin/yeucaubaohanh"><i class="far fa-edit"></i>
                        Bảo hành online</a>
                        <div class="dropdown-divider"></div>
                ...
                <?php
                    if(isset($dataview['tinhtranghd'])){
                        if($dataview['tinhtranghd'] == 'Yêu cầu bảo hành'){?>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo BASE_URL?>admin/yeucaubaohanh">Yêu cầu bảo hành</a></li>
                                <li class="breadcrumb-item active">Chi tiết yêu cầu</li>
                            </ol>
                        <?php }
                        else{?>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo BASE_URL?>admin/yeucausuachua">Yêu cầu sửa chữa</a></li>
                                <li class="breadcrumb-item active">Chi tiết yêu cầu</li>
                            </ol>
                        <?php }
                    }
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php 
                                     while ($row = mysqli_fetch_array($dataview["chitietyeucau"])){
                                         $masp = $row['masp'];
                                    ?>
                                    <tr>
                                        ...
                                        <td align="center"><?php echo $row['thoihanbaohanh'];?> Tháng</td>
                            ...
                            <div style="text-align: center;"> 
                                <?php
                                    if(isset($dataview['tinhtranghd'])){
                                        if($dataview['tinhtranghd'] == 'Yêu cầu bảo hành'){?>
                                            <a class="button2 b-red rot-135" style="width: max-content;"
                                                href="<?php echo BASE_URL?>admin/huyyeucau/<?php echo $dataview['mahd']?>/<?php echo  $masp?>"> 
                                                <i class="fas fa-times"></i> Hủy yêu cầu</a>
                                        <?php }
                                        else{?>
                                            <a class="button2 b-red rot-135" style="width: max-content;"
                                                href="<?php echo BASE_URL?>admin/huyyeucau2/<?php echo $dataview['mahd']?>">
                                                <i class="fas fa-times"></i> Hủy yêu cầu</a>
                                        <?php }
                                    }
                                ?>
