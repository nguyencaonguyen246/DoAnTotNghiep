        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item active dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item active" href="<?php echo BASE_URL?>admin/restore"><i class="fas fa-window-restore"></i>
                        Restore</a>
                </div>
            </li>
        </ul>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            if(isset($dataview["ketqua"])) {
                                                ?>
                                            <h4 class="alert alert-success"><?php echo $dataview["ketqua"]?></h4>
                                            <?php }
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Chọn file đã sao lưu trước đó</th>
                                        <td><input class="cus-input" type="file" name="filename" required="required"
                                                autofocus="autofocus" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" align="center"> <button style="width: max-content;"
                                                type="submit" name="restore" class="button2 b-blue rot-135">
                                                <i class="fas fa-check"></i> Phục hồi</button>
                                        </td>
                                    </tr>
                                </table>
                            </div>
