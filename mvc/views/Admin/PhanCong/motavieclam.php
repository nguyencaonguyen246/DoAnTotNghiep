        ...
        <div id="content-wrapper">
            ...
            <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo BASE_URL?>admin/admin_phancong/<?php echo $dataview['mahd_dieuphoi_mota']?>">Phân công</a>
                    </li>
                    <li class="breadcrumb-item active">Mô tả công việc</li>
                </ol>
                <div class="card mb-3">
                    <?php 
                        $row = mysqli_fetch_array($dataview["phancong"])
                    ?>
                    <div class="card-header">
                        
                        <h4>
                        <i class="fas fa-user-cog"></i> Tiến hành giao việc cho: <?php echo $row["tennhanvien"]?> 
                        </h4>
                    </div>
                    <form action="<?php echo BASE_URL;?>admin/post_admin_phancong/<?php echo $row["manv"];?>/<?php 
                        if($dataview['mahd_dieuphoi_mota']){
                            echo $dataview['mahd_dieuphoi_mota'];
                        }
                    ?>"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered"  width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <textarea style="width: 100%; height: 200px;" required="required" name="motacongviec"></textarea>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <button type="submit" style="width: max-content;" name="xacnhanphancong"
                                                class="button2 b-green rot-135"><i class="fas fa-screwdriver"></i> Phân công</button>
                                        </td>
