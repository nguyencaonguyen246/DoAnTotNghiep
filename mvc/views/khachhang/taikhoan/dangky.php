...
<body>
    ...
    <div class="container__form">
        <form action="<?php echo BASE_URL?>DangKyController/dangky" method="post" class="form">
            <h2 class="form__title">Đăng ký</h2>
            <!--<input name="tendangnhap" id="tendangnhap" type="text" placeholder="Tên đăng nhập" class="input" />-->
            <div class="form-group">
                <input name="sdtkhachhang" id="sodienthoai" type="number" placeholder="Số điện thoại" class="input"
                    required="required" />
                <div class="ajax_sdt">
            ...
            <div class="form-group">
                <input name="matkhau" id="matkhau" type="password" placeholder="Mật khẩu" required="required"
                    class="input" />
            </div>
            <div class="form-group">
                <input name="re_matkhau" id="re_matkhau" type="password" placeholder="Nhập lại mật khẩu" class="input"
                    required="required" />
                <div class="mess_MK">
                    <p id="messMK"></p>
                </div>
            ...
            <button type="submit" name="btnDangKy" class="btn">Đăng ký</button>
            <a href="<?php echo BASE_URL?>DangnhapController">Đăng nhập ngay</a>
            ...
            <h5><?php echo "Thông tin đăng ký không hợp lệ";  ?></h5>
            <?php 
                }
                }
            ?>
